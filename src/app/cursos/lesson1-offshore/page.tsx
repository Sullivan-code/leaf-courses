  ...
  return (
    ...
    >
      <div className="max-w-5xl mx-auto bg-[#f0f8ff] bg-opacity-95 rounded-[40px] p-10 shadow-lg">
        ...
        {/* SECTION 1 - VERBS with offshore workers image */}
            ...
            <div className="flex flex-col md:flex-row gap-6 mb-6">
              <div className="md:w-1/3">
                <div className="relative w-full h-40">
                  <Image
                    src="https://raw.githubusercontent.com/Sullivan-code/english-audios/blob/main/ChatGPT%20Image%20Jun%2012%2C%202026%2C%2006_36_03%20PM.png"
                    alt="Offshore workers on vessel"
                    fill
                ...
                <p className="text-xs text-gray-500 text-center mt-2">👥 Offshore workers</p>
              </div>
        ...
        {/* SECTION 2 - NEW WORDS with control room image */}
        <div className="bg-white border-2 border-blue-200 rounded-[30px] shadow-lg mb-10 overflow-hidden">
          <div className="bg-gradient-to-r from-blue-500 to-purple-600 text-white py-4 px-8 flex justify-between items-center">
            <div>
          ...
          <div className="p-8">
            <div className="flex flex-col md:flex-row gap-6 mb-6">
              <div className="md:w-1/3">
                ...
                <p className="text-xs text-gray-500 text-center mt-2">🎛️ Engine Control Room</p>
              </div>
              <div className="md:w-2/3">
        ...
        {/* SECTION 3 - USEFUL PHRASES with offshore crew image */}
        <div className="bg-white border-2 border-blue-200 rounded-[30px] shadow-lg mb-10 overflow-hidden">
          <div className="bg-gradient-to-r from-blue-500 to-purple-600 text-white py-4 px-8 flex justify-between items-center">
            <div>
          ...
          <div className="p-8">
            <div className="flex flex-col md:flex-row gap-6 mb-6">
              <div className="md:w-1/3">
                ...
                <p className="text-xs text-gray-500 text-center mt-2">👷 Offshore Crew at Work</p>
              </div>
              <div className="md:w-2/3">
        ...
        {/* SECTION 4 - GRAMMAR with industrial engine image */}
        <div className="bg-white border-2 border-blue-200 rounded-[30px] shadow-lg mb-10 overflow-hidden">
          <div className="bg-gradient-to-r from-blue-500 to-purple-600 text-white py-4 px-8 flex justify-between items-center">
            <div>
          ...
          <div className="p-8">
            <div className="flex flex-col md:flex-row gap-6 mb-6">
              <div className="md:w-1/3">
                ...
                <p className="text-xs text-gray-500 text-center mt-2">⚙️ Marine Diesel Engine</p>
              </div>
              <div className="md:w-2/3">
        ...
        {/* SECTION 5 - WRAP UP with AM/PM lesson and offshore images */}
        <div className="bg-white border-2 border-blue-200 rounded-[30px] shadow-lg mb-10 overflow-hidden">
