          ...
          <div className="p-8">
            ...
            {openDrills.vocabulary && (
              <div className="mt-4 bg-blue-50 rounded-2xl p-6 space-y-4 animate-fadeIn">
                ...
                <div className="p-4 bg-white rounded-xl border border-blue-200">
                  <p className="text-lg font-medium text-gray-800">6. Você prefere <span className="text-blue-600">queijo</span> ou presunto? / manteiga / leite</p>
                </div>
                <div className="p-4 bg-white rounded-xl border border-blue-200">
                ...
                <div className="p-4 bg-white rounded-xl border border-blue-200">
                  <p className="text-lg font-medium text-gray-800">9. Eu gosto de <span className="text-blue-600">chá</span> com limão. / café / leite</p>
                </div>
                <div className="p-4 bg-white rounded-xl border border-blue-200">
          ...
          <div className="p-8">
            ...
            {openDrills.usefulPhrases && (
              <div className="mt-4 bg-blue-50 rounded-2xl p-6 space-y-4 animate-fadeIn">
                ...
                <div className="p-4 bg-white rounded-xl border border-blue-200">
                  <p className="text-lg font-medium text-gray-800">4. Eu gosto de <span className="text-blue-600">pão</span> com queijo. / biscoitos / panquecas</p>
                </div>
                <div className="p-4 bg-white rounded-xl border border-blue-200">
                  <p className="text-lg font-medium text-gray-800">5. Nós comemos <span className="text-blue-600">presunto</span> no almoço. / queijo / frutas</p>
                </div>
                <div className="p-4 bg-white rounded-xl border border-blue-200">
