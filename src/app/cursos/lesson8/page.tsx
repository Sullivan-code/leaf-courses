...
// Componente para falar qualquer frase em inglês com botão de áudio
      ...
      <div className="max-w-5xl mx-auto bg-white bg-opacity-95 rounded-[40px] p-10 shadow-lg">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-700 max-w-3xl mx-auto">
            Practice speaking about languages, countries, and international communication. <strong>Click on any text in English to hear pronunciation!</strong> 🎧
          </p>
        </div>
        ...
        {/* SUBSTITUTION PRACTICE 1 COM ÁUDIO APENAS EM INGLÊS */}
                  ...
                  {subs1Exercises.map((exercise) => {
                    ...
                    return (
                      <div key={exercise.key} className="bg-white p-4 rounded-lg border border-green-200">
                        <p className="text-green-600 font-medium mb-2 block">{exercise.original}</p>
        ...
        {/* CHANGE INTO NEGATIVE COM ÁUDIO APENAS EM INGLÊS */}
                  ...
                  {subs2Exercises.map((exercise) => {
                    ...
                    return (
                      <div key={exercise.key} className="bg-white p-4 rounded-lg border border-purple-200">
                        <p className="text-purple-600 font-medium mb-2 block">{exercise.original}</p>
        ...
        {/* CHANGE INTO AFFIRMATIVE COM ÁUDIO APENAS EM INGLÊS */}
        ...
        {/* CHANGE INTO INTERROGATIVE COM ÁUDIO APENAS EM INGLÊS */}
        ...
        {/* QUESTIONS COM ÁUDIO APENAS EM INGLÊS */}
        ...
        {/* TUNE IN YOUR EARS COM ÁUDIO APENAS EM INGLÊS */}
