    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-green-50 px-6 py-16">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="space-y-8">
          {modulos.map((modulo) => (
            <div key={modulo.id} className="bg-white rounded-3xl shadow-2xl overflow-hidden border-2 border-blue-200 hover:shadow-3xl transition-all duration-300">
              {/* Cabeçalho do módulo */}
              ...
              <div className="p-6">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
                  {modulo.aulas.map((aula) => (
                    <Link key={aula.id} href={`/cursos/${aula.id}`}>
                      <div className={`
                      ...
                      `}>
                        <div className="flex items-start gap-3">
                          <div className={`
                            p-2 rounded-lg
                            ${aula.tipo === 'revisao' ? 'bg-purple-200' : 'bg-blue-200'}
                          `}>
                            {aula.tipo === 'revisao' ? (
        ...
        <div className="mt-12 bg-white p-6 rounded-2xl shadow-lg border-2 border-gray-200">
          ...
          <div className="flex items-center justify-between mb-2">
            ...
            <span className="text-blue-600 font-semibold">33%</span>
          </div>
